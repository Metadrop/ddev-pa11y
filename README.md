...
This addon uses a Docker image from [docker-aljibe-tools](https://github.com/Metadrop/docker-aljibe-tools) with a combined tag that encodes both the Pa11y version and the base image version:
...
Available versions are listed in the [docker-aljibe-tools packages](https://github.com/orgs/metadrop/packages/container/package/aljibe-tools%2Fpa11y).
